...
export default function OpexSummitAmsterdamPage() {
	return (
							...
							<div className="col-lg-8 m-auto">
								<div className="heading1 text-center">
									<h1 style={{ color: "white", textShadow: "2px 2px 4px rgba(0,0,0,0.8)" }}>
										Amsterdam EPC Forum April 2026
									</h1>
						...
						<div className="row">
							<div className="col-lg-10 m-auto">
								<div className="heading2 text-center space-margin60">
									...
									<div className="space16" />
									<p>
										Explore a series of case studies showcasing successful EPC projects from concept to completion.
										Industry leaders will share their experiences, lessons learned, and best practices that
										contributed to their success, providing attendees with actionable takeaways to apply in their
										own projects.
									</p>
								</div>
							</div>
							...
							<div className="col-lg-6 col-md-6 d-flex mb-4">
								<div className="choose-widget-boxarea h-100 w-100 opex-card">
									<div className="content-area">
										...
										<p className="opex-card-text">
											<strong>Dates:</strong> April 2026
											<br />
											<strong>Venue:</strong> Amsterdam
										</p>
									</div>
								</div>
							</div>
