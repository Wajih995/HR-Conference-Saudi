...
export default function OpexSummitLondonPage() {
	return (
							...
							<div className="col-lg-8 m-auto">
								<div className="heading1 text-center">
									<h1 style={{ color: "white", textShadow: "2px 2px 4px rgba(0,0,0,0.8)" }}>
										London Global EPC Project management Summit Sep 2026
									</h1>
						...
						<div className="row">
							<div className="col-lg-10 m-auto">
								<div className="heading2 text-center space-margin60">
									...
									<div className="space16" />
									<p>
										Join us at the World's Largest EPC Project Management Summit in London from September 23–25,
										2026. This event brings together 400+ industry leaders, project managers, and professionals from
										around the world to explore the latest trends, technologies, and best practices in EPC project
										management.
									</p>
								</div>
							</div>
							...
							<div className="col-lg-6 col-md-6 d-flex mb-4">
								<div className="choose-widget-boxarea h-100 w-100 opex-card">
									<div className="content-area">
										...
										<p className="opex-card-text">
											<strong>Dates:</strong> 23–25 Sep 2026
											<br />
